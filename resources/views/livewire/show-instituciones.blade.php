<div wire:init='loadInstituciones'>
    <x-guest-layout>
        <h3
            ...
            <x-table>
                <div class="px-6 py-4 flex items-center">
                    <x-input wire:model.live='search' type="text" class="uppercase flex-1 mx-4"
                        placeholder="Buscar institución invitada"></x-input>
                    @livewire('create-inst-invite')
                </div>
                <div wire:loading wire:target="loadInstituciones" class="py-4 px-6">
                    <div role="status">
                ...
                @if (count($instituciones))
                    <table class="min-w-full divide-y divide-gray-200 uppercase text-center">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="w-24 cursor-pointer px-6 py-3 tracking-tighter">
                                    ID
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($instituciones as $institucion)
                                <tr class="hover:bg-gray-300">
                                    ...
                                    <td>
                                        <a href="{{ route('ver.listado', $institucion) }}"
